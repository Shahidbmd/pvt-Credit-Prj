...
contract CREDIT is ERC20, Ownable {
  ...
  address public routerCA = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 panCakeSwap
  ...
  event mktgWalletUpdated(address indexed newWallet, address indexed oldWallet);

  event liqWalletUpdated(address indexed newWallet, address indexed oldWallet);
  ...
  constructor() ERC20("CREDIT", "CRT") {
    ...
    // launch buy fees
    uint256 _buyMktgFee = 1;
    uint256 _buyLiquidityFee = 0;
    uint256 _buyOperationsFee = 1;

    // launch sell fees
    uint256 _sellMktgFee = 1;
    ...
    mktgWallet = address(0x9f27d8958B96B7Ecf3117184A252DC8d2bb7463D);
    liqWallet = address(0x78dBebF22c797DA378CA2397F234a2dD71446386);
    operationsWallet = address(0xeb4C27e545e24aB5ac8b4bb2ba1020263ce02237);
